...
public class OwnedJsonPrimitiveCollectionDuckDBTest : OwnedJsonPrimitiveCollectionRelationalTestBase<OwnedJsonDuckDBFixture>
{
    public OwnedJsonPrimitiveCollectionDuckDBTest(OwnedJsonDuckDBFixture fixture, ITestOutputHelper testOutputHelper) : base(fixture, testOutputHelper)
    {
    }
