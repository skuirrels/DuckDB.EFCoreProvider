...
{
    public NonLoadingNavigationsManyToManyLoadDuckDBTest(NonLoadingNavigationsManyToManyLoadDuckDBFixture fixture) : base(fixture)
    {
    }
    ...
    [ConditionalTheory(Skip = DuckDBSkipReasons.Tbd)]
    public override async Task Load_collection_already_loaded_untyped_unidirectional(EntityState state, bool async, CascadeTiming deleteOrphansTiming)
    {
    ...
    public class NonLoadingNavigationsManyToManyLoadDuckDBFixture : ManyToManyLoadFixtureBase, ITestSqlLoggerFactory
    {
